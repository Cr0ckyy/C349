...
//    var address : String = "80 Mandai Lake Road, Singapore 729826"
    ...
    var address : String = "9 Woodlands"
    ...
    override func viewDidLoad() {
        ...
        MainImageView.image = UIImage(named: "\(imageNames[Int.random(in: 0..<imageNames.count)])")
        print("\(imageNames[Int.random(in: 0..<imageNames.count)])")
